...
export const projects: ProjectType[] = [
  ...
  {
    id: 3,
    router: '/portfolio/lens',
    image: '/assets/lens_thumb.png',
    path: 'lens',
    title: '데이터베이스 쿼리 작성이제는 쉽고 빠르게, LENS',
    type: 'Organization',
    description: '데이터베이스 쿼리 작성이제는 쉽고 빠르게, LENS',
    stacks: ['Next.js', 'TypeScript'],
  },
  {
    id: 4,
    router: '/portfolio/nerdplanet',
    image: '/assets/nerdplanet_thumb.png',
    path: 'nerdplanet',
    title: '기술의 궤도에 오르다, 너드플래닛',
    type: 'Organization',
    description: '기술의 궤도에 오르다, 너드플래닛',
    stacks: ['Next.js', 'TypeScript'],
  },
  {
    id: 5,
