...
공식 문서 상의 Virtual DOM을 이렇게 정의한다.
...
미리 Virtual DOM에 UI를 구현하고 ReactDOM에 의해 실제 DOM과 동기화되는 과정을 제조정이라고 한다.
</div>
...
Structure Model은 때떄로 문서의 표현을 트리로 표현하는 것을 의미한다.
...
![DOM Tree](https://user-images.githubusercontent.com/48702893/103141201-2b1b4a00-4735-11eb-9b9b-1b0b2b2b0b1a.png)

### 🗼 리렌더링이 성능에 미치는 영향

DOM Operation은 매우 빠르고 가볍다.
하지만 사용자의 웹앱의 데이터가 변화되거 갱신될 때,
